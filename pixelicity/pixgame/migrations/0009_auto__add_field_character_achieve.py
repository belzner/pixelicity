...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.achieve'
        db.add_column(u'pixgame_character', 'achieve',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['pixgame.Achievement']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.achieve'
        db.delete_column(u'pixgame_character', 'achieve_id')
