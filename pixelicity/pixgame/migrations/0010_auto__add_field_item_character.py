...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pixgame_item', 'character',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['pixgame.Character']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.character'
        db.delete_column(u'pixgame_item', 'character_id')
